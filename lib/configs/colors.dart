...
class AppColors {
  ...
  static const Color cardPink = Color(0xFFF38181);
  static const Color cardYellow = Color(0xFFFCE38A);
  static const Color cardGreen = Color(0xFFEAFFD0);
  static const Color cardBlue = Color(0xFF95E1D3);
  static const Color cardlightBlue = Color(0xFF98DDCA);
  static const Color cardLightGreen = Color(0xFFD5ECC2);
  static const Color cardLightPink = Color(0xFFFFD3B4);
  static const Color cardLightRed = Color(0xFFFFAAA7);
}
