...
class _BackgroundDecorationState extends State<_BackgroundDecoration> {
  Animation<double> get slideController => LifeCardInfoStateProvider.of(context).slideController;
  Animation<double> get rotateController => LifeCardInfoStateProvider.of(context).rotateController;
  ...
  Widget _buildBackground() {
    return CurrentCardSelector((card) {
