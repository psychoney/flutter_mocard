...
import 'package:mocard/ui/screens/lifecard_info/state_provider.dart';
...
class LifeCardInfoScreen extends StatefulWidget {
  @override
  _CardInfoState createState() => _CardInfoState();
}

class _CardInfoState extends State<LifeCardInfoScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return LifeCardInfoStateProvider(
