...
import 'package:mocard/ui/screens/workingcard_info/state_provider.dart';
...
class WorkingCardInfoScreen extends StatefulWidget {
  @override
  _CardInfoState createState() => _CardInfoState();
}

class _CardInfoState extends State<WorkingCardInfoScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return WorkingCardInfoStateProvider(
