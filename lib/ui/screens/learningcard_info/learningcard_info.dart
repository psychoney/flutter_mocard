...
import 'package:mocard/ui/screens/learningcard_info/state_provider.dart';
...
class LearningCardInfoScreen extends StatefulWidget {
  @override
  _LearningCardInfoState createState() => _LearningCardInfoState();
}

class _LearningCardInfoState extends State<LearningCardInfoScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return LearningCardInfoStateProvider(
